...
<div class="row">
    <div class="col-md-3">
        <div class=" card card-outline card-info">
            <div class="card-header">
                <p class="card-title mt-1" style="font-size: 22px" id="Aviso">Registrar Dependencia/Sede</p>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-12 mt-3" id="div_sede">
                                ...
                                <select name="select_sede" id="select_sede" class="form-control form-control-border">

                                </select>
                            </div>
                            <div class="col-12 mt-3" id="div_dependencia">
                                <label for="select_dependencia">Dependencia:</label>
                                <select name="select_dependencia" id="select_dependencia" class="form-control form-control-border">
    ...
    <div class="col-md-9">
        <div class=" card card-outline card-info">
            <div class="card-header">
                <p class="card-title" style="font-size: 22px">Lista de Dependencia/Sede</p>
            </div>
