...
<div class="row">
    <div class="col-md-3">
        <div class=" card card-outline card-info">
            <div class="card-header">
                <p class="card-title mt-1 text-info" style="font-size: 22px" id="Aviso"><b>Registrar Sede</b></p>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <form action="" id="formularioSede">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-3">
                                <label for="nombresede">Nombre de Sede:</label>
                                <input id="nombresede" class="form-control form-control-border">
                            </div>
                            <div class="col-md-12 mt-3">
                                <label for="ubicacion" id="label_contrasena">Ubicación:</label>
                                <textarea id="ubicacion" class="form-control form-control-border" rows="3"></textarea>
                            </div>
    ...
    <div class="col-md-9">
        <div class=" card card-outline card-info">
            <div class="card-header">
                <p class="card-title text-info" style="font-size: 22px"><b>Lista de Sedes</b></p>
            </div>
